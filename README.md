...
- body.is-preload(?), @media breakpoints at max-width: 480px, 1680px, 1280px, 980px, 736px, 480px.
- 2 em being used for p, h2, h3, h4. Percents being used on row widths and margins. 
